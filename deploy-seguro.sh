...
echo "🚀 DEPLOYMENT SEGURO - SERVICIO PYTHON CV"
echo "=========================================="

# Variables de configuración
PYTHON_SERVICE_NAME="cv-decoder-service"
PYTHON_SERVICE_PORT="8001"
REPO_URL="https://github.com/mrgomezsv/servicio_decodificador_cv.git"
BRANCH="mrg_production"
...
setup_environment() {
    ...
    if [ ! -f ".env" ]; then
        ...
        echo "- DB_USER: usuario_mysql"
        echo "- DB_PASSWORD: contraseña_mysql"
...
# Función principal
main() {
    log "Iniciando deployment seguro..."
